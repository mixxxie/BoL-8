...
function OnLoad()
	...
	if typeheal ~= nil then
		...
		AHConfig:addParam("mindmgpercent", "Min dmg percent", SCRIPT_PARAM_SLICE, 20, 0, 100, 0)
	...
	if wallslot ~= nil then
		...
		WConfig:addParam("mindmgpercent", "Min dmg percent", SCRIPT_PARAM_SLICE, 20, 0, 100, 0)
